...
export default interface GoogleApi {
  /**
...
export interface Client {
   ...
   */
  load(name: string, version: string, callback: () => any, url?: string): void;
  /**
   * Creates a HTTP request for making RESTful requests.
   * An object encapsulating the various arguments for this method.
   */
  request(args: RequestOptions): HttpRequest<any>;
  /**
   ...
   */
  setToken(token: TokenObject | null): void;
}

export type LoadCallback = (...args: any[]) => void;
...
export type CallbackOrConfig = LoadConfig | LoadCallback;

export interface HttpRequestFulfilled<T> {
  result: T;
  body: string;
  headers?: any[];
  status?: number;
...
export interface HttpRequestRejected {
  result: any | boolean;
  body: string;
  headers?: any[];
  status?: number;
 ...
 */
export interface HttpRequestPromise<T> {
 ...
 */
export interface HttpRequest<T> extends HttpRequestPromise<T> {
  /**
